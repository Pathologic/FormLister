## History
### 1.9.0
* [Enhancement] Лексиконы для украинского языка.
* [Enhancement] Для параметра lang по умолчанию используется ISO 639-1 код языка из системной настройки lang_code (Lexicon).
* [Enhancement] Вместо названия языка можно указывать его ISO 639-1 код, который преобразуется в название для поддерживаемых в админке языков для совместимости (Lexicon).
